...
class Settings(BaseSettings):
    ...
    # New encrypted-room activation is enabled by default. Disabling this
    # kill switch never downgrades or interrupts rooms already encrypted.
    e2ee_activation_enabled: bool = True
