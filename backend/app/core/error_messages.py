...
ERROR_MESSAGES: dict[str, str] = {
    ...
    "BOT_DM_ATTACHMENTS_UNAVAILABLE": "Bot file uploads are currently available only through a guild installation.",
    "BOT_DM_SCOPE_REQUIRED": "This direct-message action requires both messages.send and dm.send.",
    "BOT_INSTALLATION_REQUIRED": "Select an active bot installation for this action.",
    "BOT_E2EE_CONTENT_UNAVAILABLE": "This bot cannot read plaintext from an end-to-end encrypted channel.",
    "BOT_E2EE_DISABLED": "This bot is not enabled for encrypted interactions in this guild.",
    "BOT_E2EE_ENVELOPE_REQUIRED": "Send an encrypted envelope when this bot posts in an end-to-end encrypted channel.",
