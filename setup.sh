...
# BEGIN GENERATED QUOTA DEFAULTS
...

{
  ...
  emit KAEDE_E2EE_ACTIVATION_ENABLED "$(old_bool KAEDE_E2EE_ACTIVATION_ENABLED true)"
  ...
  emit KAEDE_MEDIA_MAX_EMOJI_BYTES "$(old_uint KAEDE_MEDIA_MAX_EMOJI_BYTES 262144)"
  emit KAEDE_MEDIA_MAX_STICKER_BYTES "$(old_uint KAEDE_MEDIA_MAX_STICKER_BYTES 524288)"
  if [[ $EMAIL == disabled ]]; then
