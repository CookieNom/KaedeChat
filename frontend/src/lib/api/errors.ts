...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  APPLICATION_DIRECTORY_NOT_READY:
    'Complete every required discovery field and add an active install path before publishing this app.',
  APPLICATION_DIRECTORY_RESPONSE_INVALID:
    "The app's home instance returned an invalid directory listing.",
  APPLICATION_DIRECTORY_UNAVAILABLE:
    "The app's home instance could not load its directory right now. Try again shortly.",
  APPLICATION_STORE_ASSET_LIMIT_REACHED:
    'An app can show at most five images or videos in its directory listing.',
  APPLICATION_DIRECTORY_MEDIA_INVALID:
    'Directory images must use uploaded assets whose kind is set to store.',
  ...
  BOT_E2EE_PARTICIPATION_NOT_FOUND: 'This app is not allowed in that encrypted channel.',
  ...
  INVALID_FEDERATION_DOMAIN: 'Enter a valid federation instance domain.',
