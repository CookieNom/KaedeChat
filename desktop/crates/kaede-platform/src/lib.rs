...
pub struct DesktopPreferences {
    ...
    pub priority_push_to_talk_hotkey: Option<String>,
    pub toggle_mute_hotkey: Option<String>,
    pub toggle_deafen_hotkey: Option<String>,
...
impl Default for DesktopPreferences {
    fn default() -> Self {
        Self {
            ...
            priority_push_to_talk_hotkey: None,
...
mod tests {
    ...
    async fn preferences_round_trip_all_native_device_choices() {
        ...
        let preferences = DesktopPreferences {
            ...
            priority_push_to_talk_hotkey: Some("Ctrl+Shift+Backquote".to_owned()),
            toggle_mute_hotkey: Some("Ctrl+Shift+M".to_owned()),
            toggle_deafen_hotkey: Some("Ctrl+Shift+D".to_owned()),
